	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Vision Code" Type="Folder">
			<Item Name="config" Type="Folder">
				<Item Name="INI_Startup.vi" Type="VI" URL="../Vision Code/config/INI_Startup.vi"/>
				<Item Name="CreateOffsetFormulaINI.vi" Type="VI" URL="../Vision Code/config/CreateOffsetFormulaINI.vi"/>
				<Item Name="CreatePitchValuesINI.vi" Type="VI" URL="../Vision Code/config/CreatePitchValuesINI.vi"/>
				<Item Name="GetOffsetFormulasINI.vi" Type="VI" URL="../Vision Code/config/GetOffsetFormulasINI.vi"/>
				<Item Name="GetPitchValuesINI.vi" Type="VI" URL="../Vision Code/config/GetPitchValuesINI.vi"/>
			</Item>
			<Item Name="overlays" Type="Folder" URL="../Vision Code/overlays">
				<Property Name="NI.DISK" Type="Bool">true</Property>
			</Item>
			<Item Name="distance calculator.vi" Type="VI" URL="../Vision Code/distance calculator.vi"/>
			<Item Name="DistanceCalculator.vi" Type="VI" URL="../Vision Code/DistanceCalculator.vi"/>
			<Item Name="Goal Cases.vi" Type="VI" URL="../Vision Code/Goal Cases.vi"/>
			<Item Name="Goal Center.vi" Type="VI" URL="../Vision Code/Goal Center.vi"/>
			<Item Name="Goal Classifier.vi" Type="VI" URL="../Vision Code/Goal Classifier.vi"/>
			<Item Name="Goal Distance Calculator.vi" Type="VI" URL="../Vision Code/Goal Distance Calculator.vi"/>
			<Item Name="Goal Highlight Updated.vi" Type="VI" URL="../Vision Code/Goal Highlight Updated.vi"/>
			<Item Name="Goal Highlight.vascr" Type="Document" URL="../Vision Code/Goal Highlight.vascr"/>
			<Item Name="Goal Highlight.vi" Type="VI" URL="../Vision Code/Goal Highlight.vi"/>
			<Item Name="Goal Picker.vi" Type="VI" URL="../Vision Code/Goal Picker.vi"/>
			<Item Name="OffsetCalculator.vi" Type="VI" URL="../Vision Code/OffsetCalculator.vi"/>
			<Item Name="OffsetCalculatorCore.vi" Type="VI" URL="../Vision Code/OffsetCalculatorCore.vi"/>
			<Item Name="Overlay.vi" Type="VI" URL="../Vision Code/Overlay.vi"/>
			<Item Name="Particle Classifier.vi" Type="VI" URL="../Vision Code/Particle Classifier.vi"/>
			<Item Name="remove class zeros.vi" Type="VI" URL="../Vision Code/remove class zeros.vi"/>
			<Item Name="sort2DArray.vi" Type="VI" URL="../Vision Code/sort2DArray.vi"/>
		</Item>
		<Item Name="Dashboard Main.vi" Type="VI" URL="../Dashboard Main.vi"/>
		<Item Name="Distance Inches to String.vi" Type="VI" URL="../Distance Inches to String.vi"/>
		<Item Name="RisingEdgeDetect.vi" Type="VI" URL="../RisingEdgeDetect.vi"/>
		<Item Name="FallingEdgeDetect.vi" Type="VI" URL="../FallingEdgeDetect.vi"/>
